...
- CoRE MOF Database (Computation-Ready, Experimental (CoRE) Metal-Organic Framework Database):
...
- PACMAN-charge (A Partial Atomic Charge Predicter for Porous Materials based on Graph Convolutional Neural Network):
